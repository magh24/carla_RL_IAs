...
if __name__ == '__main__':
    ...
    parser.add_argument('--path-folder-model', required=True, type=str,
    ...
    parser.add_argument('--nb_action_steering', type=int, default=27, help='How much different steering values in the action (should be odd)')
    parser.add_argument('--max_steering', type=float, default=0.6, help='Max steering value possible in action')
    parser.add_argument('--nb_action_throttle', type=int, default=3, help='How much different throttle values in the action')
    ...
    parser.add_argument('--crop-sky', action='store_true', default=False,
    ...
    parser.add_argument('--num-tau-samples', default=8, type=int, help='N in equation 3 in IQN paper')
    parser.add_argument('--num-tau-prime-samples', default=8, type=int, help="N' in equation 3 in IQN paper")
    ...
    args.steps_image = [-10,-2,-1,0] # We take a frame 1 sec before, and the other are 0.2, 0.1 and 0 second before (ORDER IS TAKEN INTO ACCOUNT HERE)
